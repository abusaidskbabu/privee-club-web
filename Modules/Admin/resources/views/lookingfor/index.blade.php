...
@section('title', 'Lookingfor Management')
@section('content')
    <link rel="stylesheet" href="{{ url('assets/css/modal.css') }}?v={{ time() }}">
    @include('admin::lookingfor.modal');
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="page-header-changed">
                    <div class="container-fluid">
                        <h3><i class="fas fa-flag"></i> Looking For Management</h3>
                    </div>
                </div>
            </div>
        </div>
