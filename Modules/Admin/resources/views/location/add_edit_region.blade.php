            ...
            <div class="container-fluid">
                <div class="page-header">
                    <div class="container-fluid  d-flex justify-content-between align-items-center">
                        <h3><i class="fas fa-globe"></i> {{ isset($region) && $region->id ? 'Update Region' : 'Add Region' }}
                        </h3>
                        <button class="btn btn-primary">
                            <a href="{{ route('admin.location.management') }}" class="back-btn"
                    ...
                    <div class="tab-pane fade show active" id="male" role="tabpanel" aria-labelledby="male-tab">
                        <div class="card mt-3">
                            <div class="card-body table-responsive">
                                ...
                                <form
                                    action="{{ route('admin.add.update.region', isset($region) && $region->id ? base64_encode($region->id) : '') }}"
                                    method="POST">
                                    @csrf
                                    <div class="form-group mb-3">
