...
@section('title', 'Zodiac Sign Management')
@section('content')
    <link rel="stylesheet" href="{{ url('assets/css/modal.css') }}?v={{ time() }}">
    @include('admin::zodiacsign.modal');
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="page-header-changed">
                    <div class="container-fluid">
                        <h3><i class="fas fa-flag"></i> Zodiac Sign Management</h3>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped commontable" id="ChildrenTable">
                                ...
                                <tbody class="mytable">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center text-muted py-4">No Zodiac Sign
                                                found.
                                            </td>
                                        </tr>
                                    @endforelse
